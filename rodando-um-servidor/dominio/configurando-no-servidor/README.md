...
* Qual o IP numérico do seu servidor
* Quais portas o seu servidor está utilizando
* Ter acesso para alterar os registros DNS do seu domínio
...
Caso a sua não esteja listada, poderá seguir a lógica, os paineis normalmente são extremamente parecidos.
